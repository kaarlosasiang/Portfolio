...
export default function Experience() {
  const generateSectionMarkup = () => {
    ...
    <div class="px-20">
        ...
        <div class="mt-5">
            <h3 class="flex items-center gap-3 text-lg">Frontend Web Developer <span class="text-primary font-FiraCode"> @ Wozinga</span></h3>
  ...
  return Section(generateSectionMarkup());
}
